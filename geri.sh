...
if wget -qhttps://github.com/4nni33/AnnieV2/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;32m\033[01mIniciando ¡¡AnnieV2!!\nStarting ¡¡AnnieV2!!\n\033[0m"
npm start
