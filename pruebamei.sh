...
if wget -qhttps://github.com/4nni33/PruebaMei/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;32m\033[01mIniciando ¡¡PruebaMei!!\nStarting ¡¡PruebaMei!!\n\033[0m"
npm start
