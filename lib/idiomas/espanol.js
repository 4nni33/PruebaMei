...
const smsRowner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO YO COMO CREADOR DEL BOT LO PUEDE USAR!!\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO MI CREADOR THE ZERO LO PUEDE USAR!!\`\`\`` }//OWNER
...
const smsRestrict = () => { return `\`\`\`¡¡ESTE COMANDO ESTÁ RESTRINGIDO POR MI CREADOR THE ZERO!!\`\`\`` }//RESTRINGIR COMANDO
