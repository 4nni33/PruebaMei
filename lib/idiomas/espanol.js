...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return ` ..  ✅  ٫    ̋  ⎯  *RESULTADO*\n\n` } 
const smsAvisoAG = () => { return ` ..  ⚠️  ٫    ̋  ⎯  *ADVERTENCIA*\n\n` }
const smsAvisoIIG = () => { return `..  ❕  ٫    ̋  ⎯ *INFORMACIÓN*\n\n` }
const smsAvisoFG = () => { return `..  ❌  ٫    ̋  ⎯ *ERROR*\n\n` }  
const smsAvisoMG = () => { return `..  ❗️  ٫    ̋  ⎯ *ACCIÓN MAL USADA*\n\n` }  
const smsAvisoEEG = () => { return `..  📩  ٫    ̋  ⎯ *REPORTE*\n\n` } 
const smsAvisoEG = () => { return `..  💚  ٫    ̋  ⎯ *ÉXITO*\n\n` }  

//PARÁMETROS EN COMANDOS
const smsRowner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO YO COMO CREADORA DEL BOT LO PUEDE USAR!!\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO MI CREADORA ANNIE LO PUEDE USAR!!\`\`\`` }//OWNER
const smsMods = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO MODERADORES Y MI CREADORA LO PUEDEN USAR!!\`\`\`\`` }//MODERADORES
const smsPremium = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO ESTA DISPONIBLE PARA USUARIOS PREMIUM Y MI CREADORA!! PARA SER PREMIUM COMPRE UN PASE USANDO #pass premium\`\`\`` }//USUARIOS PREMIUM
...
const smsAdmin = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO ES PARA ADMINS NO JUEGUES CON EL BOT SI NO ERES ADMIN!!\`\`\`` }//ADMINS
...
const smsRestrict = () => { return `\`\`\`¡¡ESTE COMANDO ESTÁ RESTRINGIDO POR MI CREADORA ANNIE!!\`\`\`` }//RESTRINGIR COMANDO
...
const smsLista2 = () => { return `💖 CREADORAA 💖`}
...
//_allantilink.js
const smsTextoYT = () => { return ' 🩵  AnnieBot - WhatsApp '} 
...
const smsParaAdmins = () => { return `PARA ADMINS Y CREADORA(A) : GRUPOS`}
const smsParaAdYOw = () => { return `PARA ADMINS Y CREADORA(A) : CHATS`}
const smsParaOw = () => { return `PARA CREADORA(A) : CHATS`}
...
const smsGI8 = () => { return '*CREADORA(A) DEL GRUPO*'}
...
const smskick3 = () => { return `NO PUEDO ELIMINAR AL CREADORA DEL GRUPO 😆🫵`}
...
const smsContAdult = () => { return `${lenguajeGB['smsAvisoAG']()}*LOS COMANDOS 🔞 ESTÁN DESACTIVADOS, SI USTED ES MI CREADORA(A) USE #on modohorny*`}
